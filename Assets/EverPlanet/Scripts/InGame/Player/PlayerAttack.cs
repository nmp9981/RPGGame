...
public class PlayerAttack : MonoBehaviour
{
    ...
    public Transform NearMonster()
    {
        ...
        {
            float size = Mathf.Max(gm.transform.localScale.x, gm.transform.localScale.z);//몬스터 실제 크기
            float newDist = (gm.transform.position - this.gameObject.transform.position).magnitude-size;//캐릭터와 몬스터간 거리
