...
public class PlayerBuff : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        GameManager.Instance.AttackUPCount = 0;
        GameManager.Instance.AccUPCount = 0;
        GameManager.Instance.AvoidUPCount = 0;

        accBuffTime = 0f;
        accbuffFullTime = 600f;

        avoidBuffTime = 0f;
        avoidbuffFullTime = 600f;
